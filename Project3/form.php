<?php
$userId = '75272831'; // Id телеграм аккаунта, куда отправлять сообщения
...
file_get_contents('https://api.telegram.org/bot'. $token .'/sendMessage?chat_id='. $userId .'&text=' . urlencode($msg) . '&parse_mode=markdown');  // Отправляем запрос. Разметка - markdown
	...
	echo "
		...
		<strong>Дякую, ми отримали Ваше повiдомлення.</strong>
		<a href=\"index.html\">ПОВЕРНУТИСЯ НА СТОРIНКУ</a>
		</div>
		<style>
			.safari{
				display: none;
